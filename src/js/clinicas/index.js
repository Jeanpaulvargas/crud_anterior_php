...
const getclinicas = async (alerta = 'si') => {
    const nombre = formulario.clin_nombre.value;
    const apellido = formulario.clin_sala.value;
    const url = `/crud_js/controllers/clinicas/index.php?clin_nombre=${nombre}&clin_sala=${apellido}`;
    const config = {
        method: 'GET'
    };
        ...
        if (respuesta.status == 200) {
            ...
            if (data.length > 0) {
                data.forEach(clinica => {
                    ...
                    celda2.innerText = clinica.clin_nombre;
                    celda3.innerText = clinica.clin_sala;
                    celda4.innerText = clinica.medi_nombres;
...
const guardarclinica = async (e) => {
    ...
    const url = '/crud_js/controllers/clinicas/index.php';
...
const llenardatos = (clinica) => {
    ...
    formulario.clin_nombre.value = clinica.clin_nombre;
    formulario.clin_sala.value = clinica.clin_sala;
    formulario.clin_medico_id.value = clinica.clin_medico_id;
